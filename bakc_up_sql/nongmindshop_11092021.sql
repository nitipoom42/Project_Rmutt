...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2021 at 09:16 PM
...
(2, 'Minato_Namikaze.png', 'test', '123', 'MiNaTo', 'uchiha', '0989523564', '23'),
...
INSERT INTO `stock` (`ID_Pro`, `ID_Product`, `IMG_Product`, `NAME_Product`, `PRICE_Product`, `QTY_Product`, `TYPE_Product`, `Status_Product`) VALUES
(46, '8850304081272', 'OFM1005845_X2.jpg', 'ปากกาก 1 ด้าม', 20, 155, '4', 1),
(47, '8859126000508', '8855199141018.jpg', 'น้ำโค้ก 500 มล.', 18, 181, '3', 1),
(48, '8850304002604', 'ShotType1_540x540.jpg', 'ลิปตัน 445 มล.', 20, 356, '3', 1),
(50, '456', '8850718801893_e17-07-2020.jpg', 'เลย์ สาหร่าย 50 กรัม', 35, 206, '2', 1),
(83, '6970493060482', '8850718801138_4.jpg', 'เลย์ รสพริกเผา  50 กรัม', 50, 41, '2', 2),
(84, '1232345', 'ShotType1_540x540 (1).jpg', 'ขนมไก่ย่าง', 23, 216, '2', 1),
(85, '345634', 'ShotType1_540x540 (2).jpg', 'โปเต้', 15, 16, '2', 1),
(86, '6970493060482', '307324.jpg', 'asdf', 35, 72, '4', 1);
...
(3, '8858868803088.jpg', 'ข้าวหอมมะลิ ตราฉัตร', 80, 6, '1');
...
--
ALTER TABLE `cart`
  MODIFY `ID_Cart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=842;
...
--
ALTER TABLE `oder`
  MODIFY `ID_Oder` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;

--
-- AUTO_INCREMENT for table `oder_detail`
--
ALTER TABLE `oder_detail`
  MODIFY `Oder_Detail_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=648;

--
-- AUTO_INCREMENT for table `pay`
--
ALTER TABLE `pay`
  MODIFY `ID_Pay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `stock`
  MODIFY `ID_Pro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
