...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2021 at 07:57 PM
...
(2, 'Minato_Namikaze.png', 'test', '123', 'MiNaTo', 'uchiha', '0989523564', '117'),
...
(13, 'OFM1005845_X2.jpg', 'eye', '1234', 'อาย', 'อายอาย', '', '3');
...
(121, '2021-09-05 17:13:59', 11, 4, 0),
(122, '2021-09-05 17:29:37', 11, 4, 0),
(123, '2021-09-05 17:55:21', 11, 0, 0);
...
(476, '121', '6970493060482', 1),
(477, '121', '6970493060482', 1),
(479, '122', '6970493060482', 1),
(480, '122', '6970493060482', 1),
(481, '122', '8850304081272', 1),
(482, '122', '8850304081272', 1),
(486, '123', '456', 3);
...
--
ALTER TABLE `cart`
  MODIFY `ID_Cart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=639;
...
--
ALTER TABLE `oder`
  MODIFY `ID_Oder` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;

--
-- AUTO_INCREMENT for table `oder_detail`
--
ALTER TABLE `oder_detail`
  MODIFY `Oder_Detail_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=487;
