...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2021 at 07:58 PM
...
(2, 'Minato_Namikaze.png', 'test', '123', 'MiNaTo', 'uchiha', '0989523564', 113.8),
...
(98, '2021-09-03 13:37:32', 2, 1, 0),
(99, '2021-09-03 13:39:18', 1, 3, 0),
(100, '2021-09-03 13:40:19', 1, 3, 0),
(101, '2021-09-03 16:31:25', 2, 3, 0);
...
(46, 'OFM1005845_X2.jpg', 'ปากกาก 1 ด้าม', 20, 9, '4'),
(47, '8855199141018.jpg', 'น้ำโค้ก 500 มล.', 18, 9, '3'),
(48, 'ShotType1_540x540.jpg', 'ลิปตัน 445 มล.', 20, 0, '3'),
(49, '8850718801138_4.jpg', 'เลย์ พริกเผา 50 กรัม', 35, 19, '2'),
(50, '8850718801893_e17-07-2020.jpg', 'เลย์ สาหร่าย 50 กรัม', 35, 0, '2'),
(80, 'เว็บไซต์ทำ-QR-Code-ชำระเงิน-บัญชีพร้อมเพย์.jpg', 'สาหร่ายเถ้าแก่น้อย', 35, 40, '2'),
(81, 'asdasd-07.jpg', 'ปากกาก', 20, 40, '2');
...
--
ALTER TABLE `cart`
  MODIFY `ID_Cart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=388;
...
--
ALTER TABLE `oder`
  MODIFY `ID_Oder` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `oder_detail`
--
ALTER TABLE `oder_detail`
  MODIFY `Oder_Detail_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=442;

--
-- AUTO_INCREMENT for table `pay`
--
ALTER TABLE `pay`
  MODIFY `ID_Pay` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
