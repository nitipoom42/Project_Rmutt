    ...
    <div id="box_items_product">
        ...
        <div class="row mb-2 mt-5 mx-auto justify-content-between align-items-center">
            ...
            <div class="col-2  text-center ">
                <h4 class=" rounded-pill bg_head_peoduct p-2">สินค้าขายดี</h4>
            </div>
            <div class="col">
                <div class="text-end type_full mt-2">
                    <a href="product_top_sell_full.php">ดูทั้งหมด <i class="fas fa-angle-double-right"></i></a>
                </div>
            </div>
        ...
        <div class="swiper mySwiper mb-3 ">
            <div class="swiper-wrapper">
                <?php foreach ($result_type as $row_stock) { ?>
                                        ...
                                        <div class="row text-center">
                                            <div class="col-md-6 mx-auto text-center ">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input class="form-control text-center" id="QTY<?php echo $row_stock['ID_Product']; ?>" name="QTY" type="number" min="1" value="1">
