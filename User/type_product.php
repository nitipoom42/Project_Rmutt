...
<?php
$sql_fetch_type = "SELECT  * FROM type_product WHERE NOT ID_Type_Product=1 AND Status_Product = 1";
        ...
        <?php foreach ($result_type as $row_result_type_ID) { ?>
            <div class="row mb-2 mt-5 mx-auto justify-content-between align-items-center">
                ...
                <div class="col-2  text-center ">
                    <h4 class=" rounded-pill bg_head_peoduct  p-2"> <?php echo $row_result_type_ID['INFO_Type_Product']; ?></h4>
                </div>
                <div class="col">
